...
(function (window) {
    ...
    let HZRecorder = function (stream, config) {
        ...
        config.sampleRate = context.sampleRate; //采样率(1/6 44100)
        ...
        let audioData = {
            ...
            encodeWAV: function () {
                ...
                let dataLength = parseInt(bytes.length * (sampleBits / 8))
        ...
        this.downloadRaw = function(audio) {
            this.stop();
            let data = audioData.compress();
            console.log(data)
