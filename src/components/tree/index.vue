<template>
  ...
  <!-- 删除确认弹窗 -->
  <a-modal v-model:visible="showDeleteConfirm" :footer="null">
    ...
    <div class="modal-buttons" style="border-top: 1px solid #f0f0f0">
      <a-button @click="closeDeleteConfirm" class="marginR-16">否</a-button>
      <a-button @click="onDeleteConfirm" type="primary">是</a-button>
    </div>
  </a-modal>
</template>
