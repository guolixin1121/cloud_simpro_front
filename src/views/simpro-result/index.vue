<template>
  ...
  <div class="main">
    ...
    <Table ref="table" :api="currentApi.getList" :query="query" :columns="columns" :scroll="{ x: 1800, y: 'auto' }">
...
const showVideo = (record: RObject) => {
  ...
  videoSrc.value =
    'https://10.31.255.202/x8v-drivingcloud-xtest/saimo/mp4/b2fdb736-5bde-41c2-99db-f2640399e259/61835.mp4?Expires=1683169812&AWSAccessKeyId=CB350C40B87AA1F98EC4&Signature=%2B1LmsNSKb82RA2IL4BNaTLQFvC4%3D'
}
const closeVideo = () => {
  isModal.value = false
}
