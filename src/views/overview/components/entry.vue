...
const entries = [
  { icon: icon_newtask, label: '新建任务', router: '/simpro-task/'},
  { icon: icon_scenelist, label: '场景列表', router: '/scene/'},
  { icon: icon_resource, label: '资源管理', router: '/simpro-task'},
  { icon: icon_algorithm, label: '算法管理', router: '/simpro-task'},
  { icon: icon_SOTIF, label: 'SOTIF分析', router: '/simpro-task'},
  { icon: icon_car, label: '车辆动力学', router: '/simpro-task'}
]
</script>
